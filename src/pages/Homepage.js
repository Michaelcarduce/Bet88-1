...
const Homepage = () => {
  ...
  useEffect(() => {
    document.title =
      "Bet88 | Trusted Online Casino and Sports Betting in Philippines - PAGCOR Licensed";
  ...
  return (
    <div>
      ...
      <section className="singleCompartment ptb60 plr5perc overflowXHorizontalHidden">
        <div className="compartmentStackedLayoutLeft mb60">
          ...
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            ...
            significantly for the determined effort to provide the Philippines
            players a personalized all round gaming experience.
          </p>
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
        ...
        <div className="compartmentStackedLayout">
          <p className="heading4 mb20 colorTer">
            Come and play at Bet88 now and be on the way to greatness as you go
            in for the greatest online casinos thrilling games.
          </p>
      ...
      <section className="singleCompartment ptb60 plr5perc overflowXHorizontalHidden">
        <div className="compartmentStackedLayoutLeft">
          <h2 className="heading2 colorSec pb30">
            Bet88: Your Trusted Online Casino with Robust Security and Licensing
          </h2>
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
          ...
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            ...
            Authority, one of the oldest and most respected licensing
            jurisdictions in the online gaming business. This license is a mark
            of reliability and trustworthiness, therefore Bet88 complies with
            the regulations and laws that contribute to the clean work of the
            platform and the greatest safety of its players.
          </p>
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            Bet88 is also affiliated with the Curaçao eGaming Authority which
            implies that Bet88 has to obey all the legislation that has been set
            down by the Curacao eGaming Authority. This is some assurance that
            players understand that the platform works under the law to meet all
            the requirements of offering secure and fair play. Its working
            principle is quite open and clear, and the casino goes through
            audits very frequently and has appropriate security measures when it
            comes to protecting data from breaches.
          </p>
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            Security at Bet88 is promoted by modern technologies of SSL
          ...
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            ...
            and Bank transfers Bet88 also has viable deposit and withdrawal
          ...
          <p className="descriptions textAlignmentLeft colorReg1 pb20">
            Bet88 is available for customers 24/7 through live chat and online
            support services in telegram or Facebook messenger. There is also a
            nice range of bonus promotions available at the casino Common
          ...
          <table class="customTable mb20 boxShadow1 borderRadius1">
            <tr>
              ...
              <td class="descriptions descriptionColumn">Bet88</td>
            </tr>
            <tr>
      ...
      <section className="singleCompartment ptb60 plr5perc overflowXHorizontalHidden">
        <div className="compartmentStackedLayoutLeft mb60">
          <h2 className="heading2 colorSec pb30">
            Bet88 Online: Pioneering a New Era of Gaming and Entertainment in
            the Philippines
          </h2>
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            The advancement of Bet88 Online has led to manufacturing an
          ...
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            The unique selling point that sets Bet88 apart is that it strives to
            bring the physical and virtual spaces together. What is more, they
            can communicate with other people, friends or foe, challenge the
            best ones, and cheer their triumphs. Bet88 is not a simple gaming
            site—it is a community of people, who play games and share their
            passion and achievements to create an atmosphere of friendly
            competition.
          </p>
          <p className="descriptions textAlignmentLeft colorReg1">
            With the coming of Bet88 Online, it marks a new dawn for digital
            gaming services in the Philippines. Engaging gameplay, smooth
            transactions through bKash, Nagad, and UPI along with plenty of
            bonuses to earn, Bet88 lets players create their own legends and
        ...
        <div className="compartmentStackedLayoutLeft mb60">
          <h2 className="heading2 colorSec pb30">
            Bet88 Offers a Wide Variety of Games: Join the Fun Today!
          </h2>
          <p className="descriptions textAlignmentLeft colorReg1">
        ...
        <div className="compartmentStackedLayoutLeft mb60">
          ...
          <p className="descriptions textAlignmentLeft colorReg1">
            Quality is the first concern in the Bet88 online betting platform.
            On their website, their software offers games that are not available
            on other websites from the same developers such as RT, SG, JDB,
            JILI, and CQ9 Gaming. If you like slots or prefer games with actions
            and decisions, these games will make your life brighter and more
            intriguing.
          </p>
        </div>
        ...
        <div className="compartmentStackedLayoutLeft mb60">
          ...
          <p className="descriptions textAlignmentLeft colorReg1">
            ...
            help of Bet88 online lottery games. It is easy to participate in as
            most of them are electronic, they also save a lot of money in
        ...
        <div className="compartmentStackedLayoutLeft mb60">
          ...
          <p className="descriptions textAlignmentLeft colorReg1">
            If you enjoy virtual fishing, Bet88 has developed a unique solution
            for catching the biggest fish right from the couch at home. Such
            games as virtual fishing are true copies of sea fishing but are
        ...
        <div className="compartmentStackedLayoutLeft mb60">
          <h2 className="heading2 colorSec pb30">
            Experience Gaming Excellence: Bet88’s Premier Game Providers
          </h2>
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            ...
            mission of Bet88 being ‘Excellence’ is therefore instituted to
        ...
        <div className="compartmentStackedLayoutLeft mb60">
          <h2 className="heading2 colorSec pb30">
            Bet88 User Interface: Designed for a Smooth and Engaging Experience
          </h2>
          <p className="descriptions textAlignmentLeft colorReg1">
            The Bet88 provides a stunning and ease-to-navigate interface, which
            has been created with maximum details to deliver better casino
            ...
            using their mobile, tablet, or personal computer; Bet88 guarantees
            the best user experience so players may truly enjoy their gaming
            experience. Don’t miss your chance for a perfect registration
        ...
        <div className="compartmentStackedLayoutLeft mb60">
          <h2 className="heading2 colorSec pb30">
            Bet88 Bonuses & Promotions: Unlock Bigger Rewards
          </h2>
          <p className="descriptions textAlignmentLeft colorReg1">
            At Bet88, we offer new players additional incentives so that they
            can enjoy your betting even more. Our sports betting newcomers
        ...
        <div className="compartmentStackedLayoutLeft mb60">
          <h2 className="heading2 colorSec pb30">
            Bet88 Casino Signup & Deposit: A Seamless Experience
          </h2>
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            It is very simple to become a member at Bet88 Casino through the
        ...
        <div className="compartmentStackedLayoutLeft mb60">
          <h2 className="heading2 colorSec pb30">
            Effortless and Secure: Bet88 Casino’s Trusted Payment Methods
          </h2>
          <p className="descriptions textAlignmentLeft colorReg1">
            Bet88 Casino deposits and withdrawals include several reliable
        ...
        <div className="compartmentStackedLayoutLeft">
          <h2 className="heading2 colorSec pb30">
            Download the Bet88 Casino Mobile App: Gaming Anytime, Anywhere!
          </h2>
          <p className="descriptions textAlignmentLeft colorReg1">
            In the case of mobile gaming Bet88 has developed its mobile
      ...
      <section className="singleCompartment ptb60 plr5perc overflowXHorizontalHidden">
        <div className="compartmentStackedLayoutLeft mb60">
          <h2 className="heading2 colorSec pb30">
            Get Help Anytime: Bet88 Casino Customer Support Services
          </h2>
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            On Bet88, customers can always approach the players’ support desk
            for help any time. I have also included live chat support which is
            available around the clock to assist or to answer to anyone’s
            concerns they might have. Besides, players can use the support
            tickets at support@Bet88.com for additional details and information.
            Although phone support is not available at the moment, Bet88 is very
            present on various social media including Facebook, Twitter,
            Instagram, and even on a Telegram channel.
          </p>
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
          ...
          <p className="descriptions textAlignmentLeft colorReg1 pb10">
            Bet88 Casino is not just a casino but a place where players get a
            real-time, safe, and easy experience to play games in particular
            from the Philippines, Pakistan, and India. The Bet88 online casino
            is complete with slot games, live casino, secure payment methods,
            and quick customer service available around the clock.
          </p>
          <p className="descriptions textAlignmentLeft colorReg1">
      ...
      <section className="singleCompartment ptb60 plr5perc overflowXHorizontalHidden">
        <div className="compartmentStackedLayout">
          <h2 className="heading2 colorSec pb30">FAQs for Bet88 Casino</h2>
          <div className="compartmentStackedLayout">
            <FAQAnimation
              question="How do I create an account on Bet88 Casino?"
            ...
            />
            <FAQAnimation
              question="Is Bet88 Casino secure and safe?"
              answer="Yes, Bet88 Casino of course always prioritizes the security of its players. All our data, whether personal information or finances are secured through the use of the latest encryption on the website and application. This implies that you can play video games without worrying about your data being compromised by mad hackers."
            />
            <FAQAnimation
              question="What forms of payment may I use to make deposits and withdrawals?"
              answer="Banking and Gcash, bKash, and PayTM are offered as deposit and withdrawal means at Bet88 Casino. By doing so, players can also affect their transactions with ease and security through a number of payment options."
            />
            <FAQAnimation
            ...
            <FAQAnimation
              ...
              answer="Absolutely! As for the bonuses offered to the new players of Bet88 Casino, there are the welcome bonuses and the free sign-up bonuses available. We want to give you that exciting kickstart to your gaming experience, so do not forget to visit our promotions section to find out more."
            />
            <FAQAnimation
              question="Can I use my mobile device to access Bet88 Casino?"
              answer="Yes, it has support for Bet88 Casino from your mobile device, you can play casino games through this. You can gamble on our site whenever and wherever you choose because many of our items have mobile versions. If you often play games through your phone or a tablet then you will not experience any hiccup while gaming."
            />
          </div>
        </div>
      </section>
